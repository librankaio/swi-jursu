...
@section('content')
    <section class="section">
        <div class="section-header">
            <h1>Sales Compare by Outlet</h1>
            <div class="section-header-breadcrumb">
                <div class="breadcrumb-item active"><a href="#">Report</a></div>
                <div class="breadcrumb-item"><a class="text-muted">Sales Compare by Outlet</a></div>
            </div>
        </div>
        @php
        ...
        <div class="section-body">
            ...
            <div class="row">
                <form action="/salescompare" method="get" id="myform">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row pb-3">
                                    ...
                                    <div class="col-12">
                                        <div class="mb-3">
                                            <label for="exampleInputEmail1" class="form-label">Tanggal Dari(Compare)</label>
                                            <div class="input-group date" id="dtfromcpr">
                                                <input type="text" class="form-control"
                                                    value="@php if(request('dtfromcpr')==NULL){ echo date('d/m/Y');} else{ echo $_GET['dtfromcpr']; } @endphp"
                                                    name="dtfromcpr">
                                                <span class="input-group-append">
                                                    <span class="input-group-text bg-white d-block">
                                                        <i class="fa fa-calendar"></i>
                                    ...
                                    <div class="col-12">
                                        <div class="mb-3">
                                            <label for="exampleInputEmail1" class="form-label">Sampai
                                                Tanggal(Compare)</label>
                                            <div class="input-group date" id="dttocpr">
                                                <input type="text" class="form-control"
                                                    value="@php if(request('dttocpr')==NULL){ echo date('d/m/Y');} else{ echo $_GET['dttocpr']; } @endphp"
                                                    name="dttocpr">
                                                <span class="input-group-append">
                                                    <span class="input-group-text bg-white d-block">
                                                        <i class="fa fa-calendar"></i>
