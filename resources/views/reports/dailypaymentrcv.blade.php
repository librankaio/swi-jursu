                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control select2" id="lokasi" name="lokasi"
                                                    ...
                                                    @foreach ($locations as $location)
                                                        <option value="{{ $location->value }}">{{ $location->display }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                ...
                                <table class="table table-bordered" id="datatable">
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col" class="border border-5" style="text-align: center;">Debit BCA
                                            </th>
                                            <th scope="col" class="border border-5" style="text-align: center;">Credit
                                                Non BCA</th>
                                            <th scope="col" class="border border-5" style="text-align: center;">Debit Non
                                                BCA</th>
                                            <th scope="col" class="border border-5" style="text-align: center;">
                                                M-Banking</th>
                                            <th scope="col" class="border border-5" style="text-align: center;">Credit
                                                BCA</th>
                                            <th scope="col" class="border border-5" style="text-align: center;">Qris
                                            </th>
                                            <th scope="col" class="border border-5" style="text-align: center;">Total
                                            </th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        @isset($results)
                                            ...
                                            @foreach ($results as $data => $item)
                                                ...
                                                @else
                                                    @php $grandtot = $grandtot + $total_perrow @endphp
                                                @endif
                                                <tr row_id="{{ $counter }}" id='row_{{ $counter }}'
                                                    class='text-center'>
                                                    <th style='readonly:true;' row_th="{{ $counter }}"
                                                        class='border border-5'>{{ $counter }}</th>
                                                    <td class='border border-5'>{{ $item->day }}</td>
                                                    <td class='border border-5'>{{ date('d/m/Y', strtotime($item->tdate)) }}
                                                    </td>
                                                    <td class='border border-5'>{{ number_format($item->CASH, 2, '.', ',') }}
                                                    </td>
                                                    <td class='border border-5'>
                                                        {{ number_format($item->DEBIT_BCA, 2, '.', ',') }}</td>
                                                    <td class='border border-5'>
                                                        {{ number_format($item->CC_NON_BCA, 2, '.', ',') }}</td>
                                                    <td class='border border-5'>
                                                        {{ number_format($item->DEBIT_NON_BCA, 2, '.', ',') }}</td>
                                                    <td class='border border-5'>
                                                        {{ number_format($item->mbanking, 2, '.', ',') }}</td>
                                                    <td class='border border-5'>
                                                        {{ number_format($item->CC_BCA, 2, '.', ',') }}</td>
                                                    <td class='border border-5'>{{ number_format($item->QRIS, 2, '.', ',') }}
                                                    </td>
                                                    <td class='border border-5'>
                                                        {{ number_format($total_perrow, 2, '.', ',') }}</td>
                                                </tr>
                                            @endforeach
                                        @endisset
                                    </tbody>
                                    ...
                                    <div class="col-12 col-md-12 col-lg-12">
                                        <div class="form-group">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control"
                                                    value="{{ number_format($grandtot, 2, '.', ',') }}" readonly>
                                            </div>
                                        </div>
                                    </div>
                                @endisset
