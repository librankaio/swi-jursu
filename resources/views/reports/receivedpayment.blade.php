                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col" class="border border-5" style="text-align: center;">Debit Non
                                                BCA</th>
                                            <th scope="col" class="border border-5" style="text-align: center;">m-Banking
                                            </th>
                                            <th scope="col" class="border border-5" style="text-align: center;">Credit
                                                BCA</th>
                                            ...
                                            @endif --}}
                                                <tr row_id="{{ $counter }}" id='row_{{ $counter }}'
                                                    ...
                                                    <td class='border border-5'>
                                                        {{ number_format($item->{'DEBIT BCA'}, 2, '.', ',') }}</td>
                                                    <td class='border border-5'>
                                                        {{ number_format($item->{'CREDIT NON BCA'}, 2, '.', ',') }}</td>
                                                    <td class='border border-5'>
                                                        {{ number_format($item->{'DEBIT NON BCA'}, 2, '.', ',') }}</td>
                                                    <td class='border border-5'>
                                                        {{ number_format($item->{'m-Banking'}, 2, '.', ',') }}</td>
                                                    <td class='border border-5'>
                                                        {{ number_format($item->{'CREDIT BCA'}, 2, '.', ',') }}</td>
                                                    <td class='border border-5'>
                                                        {{ number_format($item->{'QRIS'}, 2, '.', ',') }}</td>
                                                </tr>
                                            @endforeach
                                        @endisset
                                    </tbody>
