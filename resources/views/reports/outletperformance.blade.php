...
@section('content')
    <section class="section">
        <div class="section-header">
            <h1>Outlet Performance Detail</h1>
            <div class="section-header-breadcrumb">
                <div class="breadcrumb-item active"><a href="#">Report</a></div>
                <div class="breadcrumb-item"><a class="text-muted">Outlet Performance Detail</a></div>
            </div>
        </div>
        @php
        ...
        <div class="section-body">
            ...
            <div class="row">
                <form action="/outletperformance" method="get" id="myform">
                                ...
                                <table class="table table-bordered" id="datatable">
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col" class="border border-5" style="text-align: center;">Outlet
                                            </th>
                                            <th scope="col" class="border border-5" style="text-align: center;">Trans
                                            </th>
                                            <th scope="col" class="border border-5" style="text-align: center;">Sales
                                            </th>
                                            <th scope="col" class="border border-5" style="text-align: center;">Cost
                                            </th>
                                            ...
                                            @foreach ($results as $data => $item)
                                                ...
                                                <tr row_id="{{ $counter }}" id='row_{{ $counter }}'
                                                    ...
                                                    <td class='border border-5'>
                                                        {{ number_format($item->sales + $item->trans, 2, '.', ',') }}</td>
                                                </tr>
                                            @endforeach
                                        @endisset
                                    </tbody>
