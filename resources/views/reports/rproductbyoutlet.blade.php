                    ...
                    <div class="col-12 col-md-12 col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <div class="row pb-3">
                                    <div class="col-12">
                                        <input type="text" class="form-control" value="OK" id="hdn_submit"
                                            name="hdn_submit" style="display: none;">
                                        <button type="submit" class="btn btn-primary px-5" onclick="show_loading()"><span>
                                                View Laporan</span></button>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <table class="table table-bordered" id="datatable">
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col" class="border border-5" style="text-align: center;">Category
                                            </th>
