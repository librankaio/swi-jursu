...
@section('content')
    <section class="section">
        ...
        <div class="section-body">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="tujuan" name="tujuan"
                                                readonly form="thisform">
                                        </div>
                                        <div class="form-group" hidden>
                                            <label>Code Tujuan</label>
                                            <input type="text" class="form-control" id="code_tujuan" name="code_tujuan"
                                                readonly form="thisform">
                                        </div>
                                        <div class="form-group">
                                            <label>Tanggal</label>
                                            <input type="date" class="form-control" name="dt" id="dt"
                                                value="{{ date('Y-m-d') }}" form="thisform" readonly>
                                        </div>
                                    </div>
                                </div>
                                {{-- <div class="row">
            ...
            <div class="row">
                <div class="col-12 col-md-12 col-lg-12">
                    <form action="/packlistv2/update" method="GET" id="thisform">
                        <div class="card">
                            <div class="card-body">
                                <div class="row pb-3">
                                    <div class="col-6"></div>
                                ...
                                <div class="table-responsive">
                                    <div class="form-group">
                                        {{-- <label>counter</label> --}}
                                        <input type="text" class="form-control" id="number_counter" value="0" hidden
                                            readonly>
                                    </div>
                                    ...
                                    <div class="col-md-12 d-flex justify-content-end">
                                        <div class="form-group">
                                            <button class="btn btn-primary mr-1" id="confirm" type="submit"
                                                onclick="show_loading()">Approve</button>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $(document).ready(function() {
                ...
                $(document).on("click", "#addItem", function(e) {
                    ...
                    tablerow = `<tr row_id="${counter_row}" id='row_${counter_row}' class='text-center'>
                                ...
                                <td class='border border-5'>
                                    <input class="form-check-input checkbox" type="checkbox" name="checked_item_${counter_row}" value="Y" checked>
                                </td>
                            ...
                            $.ajax({
                                ...
                                success: function(response) {
                                    ...
                                    for (i = 0; i < response.length; i++) {
                                        tablerow = `<tr row_id="${counter_row}" id='row_${counter_row}' class='text-center'>
                                        <th style='readonly:true;' row_th="${counter}" class='border border-5'>${counter}</th>
                                        <td class='border border-5'><input style='width:100%;' readonly form='thisform' class='nosjclass form-control' name='nosj_d[]' type='text' value='${response[i].no}'></td>
                                        <td class='border border-5'><input style='width:100%;' readonly form='thisform' class='tanggalclass form-control' name='tanggal_d[]' type='text' value='${formatDate(response[i].tdate)}'></td>
                                        <td class='border border-5'><input style='width:100%;' readonly form='thisform' class='tujuanclass form-control' name='tujuan_d[]' type='text' value='${response[i].name_mlokasi2}'></td>
                                        <td class='border border-5'><input style='width:100%;' readonly form='thisform' class='kodeclass form-control' name='kode_d[]' type='text' value='${response[i].code_mitem}'></td>
                                        <td class='border border-5'><input style='width:100%' readonly form='thisform' class='namaitemclass form-control' name='nama_item_d[]' type='text' value='${response[i].name_mitem}'></td>
                                        <td class='border border-5'><input style='width:100%;' readonly form='thisform' class='quantityclass form-control' name='quantity_d[]' type='text' value='${thousands_separators(parseFloat(response[i].qty))}'></td>
                                        <td class='border border-5 align-items-center pb-3 pr-2'>
                                            <input class="form-check-input checkbox" type="checkbox" id="checked_item" checked>
                                        </td>
                                        <td class='border border-5' hidden><input style='width:100%' readonly form='thisform' class='namaitemclass form-control' name='checked_item[]' id='checked_item_val' type='text' value='Y'></td>
                                        <td class='border border-5'><a title='Delete' class='delete'><i style='font-size:15pt;color:#6777ef;' class='fa fa-trash'></i></a></td>
                                        </tr>`;
                                        counter++;
                                        counter_row++;
                ...
                $(document).on("click", "#checked_item", function(e) {
                    var checkboxValue = $(this).prop('checked') ? 'Y' : 'N';
                    console.log(checkboxValue);
                    $(this).closest('tr').find('#checked_item_val').val(checkboxValue);
                })
